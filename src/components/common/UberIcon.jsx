// Logo oficial de Uber (wordmark vectorial exacto, fuente: Simple Icons) sobre un
// tile negro de marca, blanco sobre negro como en el lockup oficial de Uber.
// Colores de marca fijos (no cambian con el tema). Tamaño vía className.
export default function UberIcon({ className }) {
  return (
    <svg viewBox="0 0 24 24" className={className} aria-label="Uber" role="img">
      <rect x="0.5" y="0.5" width="23" height="23" rx="6" fill="#000000" stroke="#FFFFFF" strokeOpacity="0.16" />
      <g transform="translate(2.5 2.45) scale(0.8)" fill="#FFFFFF">
