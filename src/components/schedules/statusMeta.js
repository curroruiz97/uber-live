...
import { CheckCircle2, AlertTriangle, UserX, CalendarOff, Sparkles, Percent, Ban } from 'lucide-react'

// Estados v2: cumple → parcial → ausente; justificado (excusado) y extra (no programado).
...
export const STATUS_ORDER = ['cumple', 'parcial', 'ausente', 'justificado', 'extra']
