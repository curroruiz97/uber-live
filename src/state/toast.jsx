...
export function ToastProvider({ children }) {
  ...
  return (
    <ToastContext.Provider value={{ toast }}>
      {children}
      <div className="pointer-events-none fixed inset-x-4 bottom-[calc(4.75rem+var(--sab,env(safe-area-inset-bottom)))] z-[100] flex flex-col gap-2 sm:inset-x-auto sm:bottom-4 sm:right-4 sm:w-full sm:max-w-sm md:bottom-4">
        {toasts.map((t) => {
